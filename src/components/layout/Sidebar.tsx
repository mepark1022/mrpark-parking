...
const defaultMenuItems = [
  ...
  { id: "analytics", href: "/v2/analytics", label: "매출 분석", icon: (
...
const managementMenuItems = [
  ...
  { id: "accident", href: "/v2/accident", label: "사고보고", icon: (
  ...
  { id: "alimtalk", href: "/v2/alimtalk", label: "알림톡 로그", icon: (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 15a2 2 0 01-2 2H7l-4 4V5a2 2 0 012-2h14a2 2 0 012 2z"/><line x1="8" y1="10" x2="16" y2="10"/><line x1="8" y1="14" x2="13" y2="14"/></svg>
  )},
