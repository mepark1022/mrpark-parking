...
export const ErrorCodes = {
  ...
  REPORT_NOT_FOUND:     'REPORT_NOT_FOUND',      // 일보 미존재
  REPORT_NOT_SUBMITTED: 'REPORT_NOT_SUBMITTED',  // 제출되지 않은 일보 확정 시도
  REPORT_INVALID_STATUS:'REPORT_INVALID_STATUS', // 잘못된 상태 전환
  REPORT_STORE_FORBIDDEN:'REPORT_STORE_FORBIDDEN', // 배정되지 않은 사업장
  REPORT_NOT_OWNER:     'REPORT_NOT_OWNER',      // 본인 작성분이 아님 (OPERATE 수정)
