  ...
  return (
    <AppLayout>
      <div className="max-w-5xl">
        ...
        {/* ===== 초대 모달 ===== */}
        {showInvite && (
          <div className="fixed inset-0 bg-black/50 flex items-end md:items-center justify-center z-[300] p-0 md:p-4">
            <div className="bg-white rounded-t-2xl md:rounded-2xl p-5 md:p-7 w-full md:max-w-md shadow-2xl max-h-[92vh] overflow-y-auto" style={{ paddingBottom: "calc(100px + env(safe-area-inset-bottom, 0px))" }}>
        ...
        {/* ===== 계정 생성 확인 팝업 ===== */}
        {showConfirmCreate && (
          <div className="fixed inset-0 bg-black/50 flex items-center justify-center z-[310] p-4">
        ...
        {removeTarget && (
          <div className="fixed inset-0 bg-black/50 flex items-end md:items-center justify-center z-[300] p-0 md:p-4">
            <div className="bg-white rounded-t-2xl md:rounded-2xl p-5 md:p-7 w-full md:max-w-sm shadow-2xl" style={{ paddingBottom: "calc(100px + env(safe-area-inset-bottom, 0px))" }}>
