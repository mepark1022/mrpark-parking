...
| Part | 항목 | 우선순위 | 상태 |
|------|------|----------|------|
| 13.1 | 매장 설정 토글 (5개 필드) | P0 | ⏳ DB완료 / UI 미구현 |
| 13.2 | 권한 관리 시스템 (3단계) | P0 | ⏳ DB완료 / UI 미구현 |
| 13.3 | 알림 설정 (3종류 × 3방식) | P0 | ⏳ DB완료 / UI 미구현 |
| 13.4 | 매장 선택 화면 | P0 | ⏳ 크루앱 개발 시 구현 |
| 13.5 | 월주차 만료 처리 | P1 | ⏳ UI 미구현 |
| 13.6 | 추가요금 결제 (유예시간 초과) | P1 | ⏳ UI 미구현 |
| 13.7 | 퇴근 처리 요청 승인 | P1 | ⏳ DB완료 / UI 미구현 |
| 13.8 | 근태 미출퇴근 집계 | P1 | ⏳ UI 미구현 |
...
### 1순위: Supabase SQL 직접 실행 ✅ 완료 (2026.2.23)
