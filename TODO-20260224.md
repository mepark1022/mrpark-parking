...
> **마지막 업데이트:** 2026.3.10 KST
> **마지막 작업:** 출퇴근/근태 4건 버그 수정 + 대시보드 근무인원 연동
...
- **출퇴근/근태 버그 4건 수정**: 대시보드 근무인원 연동 + 매장필터링 ID + 재요청 날짜/시간 ✅ (2026.3.10)

### 다음 작업 우선순위 (2026.3.5 저녁)
1. ✅ **mepark_tickets RLS anon 정책 수정** — 이미 적용 완료 확인 (2026.3.10)
