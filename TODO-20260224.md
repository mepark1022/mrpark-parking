...
| 2026.3.4 | 매장/주차장 삭제 커스텀 확인 모달 추가 (연관 데이터 표시 + 로딩) | ✅ 완료 |
| 2026.3.4 | 매장 삭제 서버 API 전환 (/api/stores/delete, service role RLS 우회) | ✅ 완료 |
| 2026.3.4 | 매장 삭제 cascade 순서 완성 (accident_reports, mepark_tickets 계열 포함 전체) | ✅ 완료 |
