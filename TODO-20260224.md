...
| 2026.3.4 | 크루앱 입차등록 한글 차량번호 입력 지원 (IME 호환, autoCapitalize off) | ✅ 완료 |
| 2026.3.4 | stores 테이블 누락 컬럼 추가 SQL (enable_*, gps_radius, lat/lng 등 11개) | ✅ 완료 |
| 2026.3.4 | 사이드바 배지 하드코딩 제거 → DB 실시간 카운트 (입차현황/사고보고) | ✅ 완료 |
